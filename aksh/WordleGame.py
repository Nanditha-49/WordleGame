...
class WordleGame:
    def __init__(self, master, target_word):
        self.master = master
        ...
        self.attempts = 0
        self.max_attempts = 5
        self.image_path = r"C:\Users\91939\Downloads\image.png"
        ...
        self.background_label.place(x=10, y=10, relwidth=5, relheight=5)
...
if __name__ == "__main__":
    ...
    image_path = r"C:\Users\91939\Downloads\image.png"
    background_image = tk.PhotoImage(file=image_path)
    background_image = background_image.subsample(2)  # Adjust the factor as needed

    # Create a Label to display the background image
    background_label = tk.Label(image=background_image)
    background_label.place(x=10, y=10, relwidth=5, relheight=5)
